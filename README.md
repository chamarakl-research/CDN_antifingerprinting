...
5. **Line34:** ```server tor2 10.42.0.2:9120 check``` *Change NUC LAN interface IP address to match your configuration*
6. **Line35:** ```server tor3 10.42.0.3:9130 check``` *Change NUC LAN interface IP address to match your configuration*
7. **Line36:** ```server tor4 10.42.0.4:9140 check``` *Change NUC LAN interface IP address to match your configuration*
8. **Line37:** ```server tor5 10.42.0.5:9150 check``` *Change NUC LAN interface IP address to match your configuration*
